            ...
            <div className="space-y-4">
              ...
              <div className="bg-white/50 border border-black/10 rounded-xl p-5">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-4 py-2.5 bg-white border border-black/10 rounded-lg text-sm text-black focus:outline-none focus:ring-2 focus:ring-black/20 resize-none placeholder-neutral-400"
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/50 border border-black/10 rounded-xl p-5 space-y-4">
              <div>
                ...
                <select className="w-full px-4 py-2.5 bg-white border border-black/10 rounded-lg text-sm text-black focus:outline-none focus:ring-2 focus:ring-black/20 placeholder-neutral-400">
