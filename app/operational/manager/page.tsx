...
import { 
  AlertTriangle, Snowflake, Lock, Activity, Search, Bell,
  FileText, Clock
} from "lucide-react";
import ComplaintsTab from "@/components/operational/ComplaintsTab";

type TabType = "dashboard" | "complaints";
...
export default function ManagerDashboardPage() {
  ...
  const tabs: { key: TabType; label: string }[] = [
    ...
    { key: "complaints", label: "Team & Staff Complaints" },
  ];
        ...
        <div className="lg:w-1/3 space-y-6">
          ...
          <section className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden flex flex-col h-auto">
            ...
            <div className="p-5 space-y-6">
              <ActivityItem title="New Escalation: Power Surge" time="JUST NOW" description="Reported in Engineering Hub B..." />
              <ActivityItem title="System Alert: Server Latency" time="4M AGO" description="PMS synchronization delayed by 2s." />
              <ActivityItem title="Complaint Resolved: Room 302" time="12M AGO" description="Resolved by Staff: Sarah K." />
              <ActivityItem title="New Staff Assigned: Front Desk" time="22M AGO" description="Shift change: Mark T. logged in." />
              <ActivityItem title="Priority High: Leakage" time="1H AGO" description="Water pressure warning in Kitchen." />
            </div>
