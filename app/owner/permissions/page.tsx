        ...
        <div className="flex flex-wrap gap-2">
          {roles.map(r => (
            <button key={r} onClick={() => setSelectedRole(r)}
              className={`px-4 py-2 rounded-xl text-sm transition-all ${selectedRole === r ? "bg-black text-white shadow-sm" : "bg-neutral-50 border border-black/10 text-neutral-700 hover:border-black/20"}`}
