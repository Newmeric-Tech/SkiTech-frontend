...
export default function ManagerEmployeeRankingDashboard() {
  ...
  const analyticsCards = [
    ...
    },
    {
      ...
      subtext: "Currently ranked employees",
      change: 0,
      color: "#6366F1",
    },
    {
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        {loading ? (
          ...
          <div className="text-sm text-slate-500 py-6 text-center bg-white rounded-2xl border border-slate-200/60">
            No rankings yet — click <span className="font-medium">Recalculate</span> to generate rankings for this period.
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
            {top5.map((r, i) => (
      ...
      {/* AI Insights + Ranking Table Preview */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <RankingTable
            ...
            onViewAll={() => router.push("/manager/employee-ranking/ranking-table")}
            basePath="/manager/employee-ranking"
          />
        </div>
      </div>
