...
function Rule({ delay = 0 }: { delay?: number }) {
  ...
  return (
    <motion.div
      ...
      className="h-px origin-left w-full my-20"
...
export default function AboutUs() {
  ...
  return (
    ...
    >
      ...
      <section
        ref={heroRef}
        className="relative min-h-screen flex flex-col justify-center items-center px-6 pt-28 pb-24 overflow-hidden"
      >
        {/* Radial glow */}
        <div className="pointer-events-none absolute inset-0">
          <div
            className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[500px] rounded-full blur-[120px]"
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden opacity-[0.04]">
          {Array.from({ length: 18 }).map((_, i) => (
            <div
              ...
              style={{ top: `${(i + 1) * 5.5}%`, background: "var(--mk-text-1)" }}
            />
          ))}
        </div>
        ...
        <motion.div style={{ y: heroY, opacity: heroOpacity }} className="relative z-10 text-center max-w-5xl mx-auto">
          ...
          <motion.p
            ...
            className="text-[10px] uppercase tracking-[0.25em] mb-10 font-light"
            style={{ fontFamily: font, color: "var(--mk-text-3)" }}
          >
            About SkiTech
          </motion.p>
        ...
        >
          <motion.div
            ...
            className="w-px h-10"
            style={{
              background: "linear-gradient(to bottom, var(--mk-text-3), transparent)",
            }}
          />
        </motion.div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-6 py-24">
        ...
        <FadeUp>
          <p
            className="leading-[1.9] text-center"
            style={{ fontSize: "clamp(1.05rem, 2.2vw, 1.35rem)", fontWeight: 300, color: "var(--mk-text-2)" }}
          >
            SkiTech is redefining how modern property operations are managed —
            combining{" "}
            <span style={{ color: "var(--mk-text-1)", fontWeight: "normal" }}>automation</span>,{" "}
            <span style={{ color: "var(--mk-text-1)", fontWeight: "normal" }}>intelligence</span>, and{" "}
            <span style={{ color: "var(--mk-text-1)", fontWeight: "normal" }}>simplicity</span> into one
            seamless platform.
          </p>
        </FadeUp>
        ...
        <FadeUp delay={0.15}>
          <p
            className="leading-[1.9] text-center mt-8"
            style={{ fontSize: "clamp(0.95rem, 1.8vw, 1.1rem)", fontWeight: 300, color: "var(--mk-text-3)" }}
          >
      ...
      <section
        className="py-20"
        style={{ borderTop: "1px solid var(--mk-border)", borderBottom: "1px solid var(--mk-border)" }}
      >
            ...
            {[
              ...
              <FadeUp key={i} delay={i * 0.1} className="text-center py-8 px-6">
                ...
                <p
                  ...
                  style={{ fontWeight: 400, color: "var(--mk-text-3)" }}
                >
                  {stat.label}
                </p>
              </FadeUp>
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-10 py-28">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <GlassCard delay={0} className="p-10 lg:p-14 relative overflow-hidden">
            ...
            <p className="leading-relaxed text-sm" style={{ fontWeight: 300, color: "var(--mk-text-3)" }}>
      ...
      >
        <FadeUp className="mb-16 text-center">
          <p className="text-[10px] tracking-[0.3em] uppercase mb-4" style={{ color: "var(--mk-text-3)" }}>
            What we stand for
          </p>
          <h2
            style={{
      ...
      >
        <div className="pointer-events-none absolute inset-0">
          <div
            className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] rounded-full blur-[100px]"
            style={{ background: "var(--mk-hero-glow)" }}
          />
        </div>
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          <FadeUp>
            <p className="text-[10px] tracking-[0.3em] uppercase mb-10" style={{ color: "var(--mk-text-3)" }}>
              The bottom line
            </p>
            <h2
            ...
            <p
              className="text-sm leading-relaxed max-w-xl mx-auto mb-14"
              style={{ fontWeight: 300, color: "var(--mk-text-3)" }}
            >
          ...
          <FadeUp delay={0.2}>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link
                ...
                onMouseEnter={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = "var(--mk-text-1)"; }}
                onMouseLeave={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = "var(--mk-text-2)"; }}
              >
                Get in touch ↗
              </Link>
            </div>
